...
Route::get('/search_invoice',action: [InvoiceController::class,'search_invoice']);
...
Route::delete('/delete_invoice_item/{id}', [InvoiceItemController::class, 'delete_invoice_item']);
